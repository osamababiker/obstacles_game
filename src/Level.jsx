...
/**
 * Initiate the game geomatries and materials
 * Using native THREEjs
 */
...
/**
 * Create the spinner abstacle
 * */ 
 export function BlockSpinner({ position = [0, 0, 0] }) {

    const obstacleRef = useRef()
    /* 
    * create random value to rotate the abstacle randomly
    */
   const [ speed ] = useState(() => (Math.random() + 0.02) * ( Math.random() < 0.5 ? -1 : 1 ))
    ...
    return <group position={ position }> 
        ...
        {/* Abstacle Box */}
        {/* Add the Physics */} 
        <RigidBody ref={ obstacleRef } type="kinematicPosition" position={ [ 0, 0.3, 0 ] } restitution={ 0.3 } friction={ 0 }>  
